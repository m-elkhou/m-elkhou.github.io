...
- [`css/style.css`](css/style.css) is the original dark/cyan theme, refined: design tokens (dark and light palettes), Inter via Google Fonts, layout, animations (played for every visitor, including when the OS asks for reduced motion).
